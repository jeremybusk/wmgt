...
Foreach ($secureCipher in $secureCiphers) {
  ...
  New-ItemProperty -path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\$secureCipher" -name 'Enabled' -value 1 -PropertyType 'DWord' -Force | Out-Null
  $key.close()
