...
# The docs are confusing on MS site but you need 0xffffffff for ciphers to work.
...
# Disable TLS 1.0 for client and server SCHANNEL communications lync 2010 dialin
